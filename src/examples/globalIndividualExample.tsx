...
function GlobalIndiviualModeExample({
  ...
  return (
    <ComponentWrapper
      title="Global-Individual Mode"
      description="The ultimate flexibility: combine global edit/read state with granular per-field editability. Some fields can be forced into edit mode while others follow the global state."
