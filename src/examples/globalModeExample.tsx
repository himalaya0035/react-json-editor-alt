...
function GlobalModeExample({
  ...
  return (
    <ComponentWrapper
      title="Global Editing Mode"
      description="Toggle between view and edit modes for the entire JSON object. Ideal for controlled editing workflows where you want to explicitly enter an 'edit' state."
...
export default GlobalModeExample;
